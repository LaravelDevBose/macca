        ...
        <div class="container ">
            <div class="vd_top-nav vd_nav-width  ">
                <div class="vd_panel-header">
                    <div class="logo">
                        <a href="index.html"><img alt="logo" src="<?= base_url();?>libs/img/logo.png"></a>
                    </div>
                    <!-- logo -->
                    ...
                    <div class="col-sm-7 col-xs-12">
                        <div class="vd_mega-menu-wrapper">
                            <div class="vd_mega-menu pull-right">
                                <ul class="mega-ul">
                                    <li id="top-menu-1" class="one-icon mega-li" style="display: none;"> 
                                            ...
                                            <div class="child-menu">  
                                                ...
                                                <div class="content-grid column-xs-2 column-sm-3 height-xs-4">  
                                                    <div data-rel="scroll">
                                                        <ul class="list-wrapper">
                                                            <li> <a href="#"> 
                                                                    <div class="menu-icon"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar.jpg"></div> 
                                                                </a>
                                                            ...
                                                            <li class="warning"> 
                                                                <a href="#"> 
                                                                    <div class="menu-icon"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar-2.jpg"></div>  
                                                                </a>                            
                                                            ...
                                                            <li> <a href="#"> 
                                                                    <div class="menu-icon"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar-3.jpg"></div> 
                                                                </a>    
                                                            ...
                                                            <li> <a href="#"> 
                                                                    <div class="menu-icon"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar-4.jpg"></div> 
                                                                </a>    
                                                            ...
                                                            <li> <a href="#"> 
                                                                    <div class="menu-icon"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar-5.jpg"></div>  
                                                                </a>   
                                                            ...
                                                            <li> <a href="#"> 
                                                                    <div class="menu-icon"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar-6.jpg"></div>
                                                                </a>    
                                                            ...
                                                            <li> <a href="#"> 
                                                                    <div class="menu-icon"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar-7.jpg"></div> 
                                                                </a>   
                                                            ...
                                                            <li> <a href="#"> 
                                                                    <div class="menu-icon"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar-8.jpg"></div>
                                                                </a>    
                                    ...
                                    <li id="top-menu-2" class="one-icon mega-li" style="display: none;"> 
                                        <a href="index.html" class="mega-link" data-action="click-trigger">
                                                ...
                                                <div class="content-list">  
                                                    <div  data-rel="scroll">    
                                                        <ul  class="list-wrapper pd-lr-10">
                                                            ...
                                                            <li> <a href="#"> 
                                                                    <div class="menu-icon vd_green"><img alt="example image" src="<?= base_url();?>libs/img/avatar/avatar.jpg"></div> 
                                    ...
                                    <li id="top-menu-profile" class="profile mega-li"> 
                                        <a href="#" class="mega-link"  data-action="click-trigger"> 
                                            <span  class="mega-image">
                                                <img src="<?= base_url();?>libs/img/avatar/avatar.jpg" alt="example image" />               
                                            </span>
                                    ...
                                    <li id="top-menu-settings" class="one-big-icon hidden-xs hidden-sm mega-li" data-intro="<strong>Toggle Right Navigation </strong><br/>On smaller device such as tablet or phone you can click on the middle content to close the right or left navigation." data-step=2 data-position="left" style="display: none;"> 
