                        ...
                        <div class="vd_login-page" style="background: #26e6d66e;">
                            ...
                            <div class="panel widget">
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" id="login-form" action="<?= base_url();?> admin/login/check" method="POST" role="form">
                                        <div class="alert alert-danger vd_hidden">
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                            <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> User Name and Password Not Match 
                                        </div>
                                        <div class="alert alert-success vd_hidden">
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                                            <span class="vd_alert-icon"><i class="fa fa-check-circle vd_green"></i></span><strong>Well done!</strong>. Your Are login Successfully.
                                        </div>                  
                                        <div class="form-group  mgbt-xs-20">
                                            <div class="col-md-12">
                                                ...
                                                <div class="vd_input-wrapper" style="background-color: #fff; margin-bottom: 2px;" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-user" style="line-height: 2.3;"></i> </span>
                                                    <input type="text" placeholder="User name" id="email" name="username" class="required" required autocomplete="false">
                                                </div>
